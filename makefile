...
COMPILE_DEBUG = ${COMPILE} ${CFLAGS} -DEBUG
...
compile_and_test_array_handler: make_build_dir
	...
	${COMPILE_DEBUG} ${TEST_DIR}/ArrayHandlerTest.c -o ${BUILD_DIR}/ArrayHandlerTest -I${TEST_FRMAWORK_DIR} -L${BUILD_DIR} -lArrayHandler -I${HEADERS_DIR}	
...
compile_and_test_subheap_handler: make_build_dir
	...
	${COMPILE_DEBUG} ${TEST_DIR}/SubheapHandlerTest.c -o ${BUILD_DIR}/SubheapHandlerTest -I${TEST_FRMAWORK_DIR} -L${BUILD_DIR} -lSubheapHandler -I${HEADERS_DIR}	
...
compile_and_test_memory_manager: compile_and_test_array_handler compile_and_test_subheap_handler
	...
	${COMPILE_DEBUG} ${TEST_DIR}/MemoryManagerTest.c -o ${BUILD_DIR}/MemoryManagerTest -I${TEST_FRMAWORK_DIR} -L${BUILD_DIR} -lMemoryManager -I${HEADERS_DIR}	
...
compile_and_test_multi_thread_handler: make_build_dir
	...
	${COMPILE_DEBUG} ${TEST_DIR}/MultiThreadHandlerTest.c -o ${BUILD_DIR}/MultiThreadHandlerTest -I${TEST_FRMAWORK_DIR} -L${BUILD_DIR} -lMultiThreadHandler -I${HEADERS_DIR} -lpthread
...
compile_and_test_single_thread_task_runner: make_build_dir
	...
	${COMPILE_DEBUG} ${TEST_DIR}/SingleThreadTaskRunnerTest.c -o ${BUILD_DIR}/SingleThreadTaskRunnerTest -I${TEST_FRMAWORK_DIR} -L${BUILD_DIR} -lSingleThreadTaskRunner -I${HEADERS_DIR}
...
compile_and_test_timer: make_build_dir
	...
	${COMPILE_DEBUG} ${TEST_DIR}/TimerTest.c -o ${BUILD_DIR}/TimerTest -I${TEST_FRMAWORK_DIR} -L${BUILD_DIR} -lTimer -I${HEADERS_DIR}	
	./${BUILD_DIR}/TimerTest
	${END_MSG} timer
...
compile_and_test_random: compile_and_test_timer
	...
	${COMPILE_DEBUG} ${TEST_DIR}/RandomTest.c -o ${BUILD_DIR}/RandomTest -I${TEST_FRMAWORK_DIR} -L${BUILD_DIR} -lRandom -I${HEADERS_DIR}	
...
compile_and_test_size_generator: compile_and_test_random
	...
	${COMPILE_DEBUG} ${TEST_DIR}/SizeGeneratorTest.c -o ${BUILD_DIR}/SizeGeneratorTest -I${TEST_FRMAWORK_DIR} -L${BUILD_DIR} -lSizeGenerator -I${HEADERS_DIR}	
...
compile_and_test_cyclic_list: make_build_dir
	...
	${COMPILE_DEBUG} ${TEST_DIR}/CyclicListTest.c -o ${BUILD_DIR}/CyclicListTest -I${TEST_FRMAWORK_DIR} -L${BUILD_DIR} -lCyclicList -I${HEADERS_DIR}	
