...
void test_generateIntByWidth() {
	...
	assertTrue("Value is out if width", 0 <= value && value < width);
    }

    assertTrue("If width eq 0, should return 0", 0 == generateIntByWidth(0));
    assertTrue("If width eq 1, should return 0", 0 == generateIntByWidth(1));
}
...
void test_generateIntByRange() {
	...
	assertTrue("Value is out of range", start <= value && value < end);
    }

    assertTrue("Range should swap params, if end < start", 99 == generateIntByRange(100, 99));
}
