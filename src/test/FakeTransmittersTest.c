...
void test_case() {
    ...
    assertLongEquals("Returned msg should has regular type", 1, *msg & 0xff);
    ...
    assertLongEquals("Should return generated msg", msg[7] & 0xff, extraMessage[1] & 0xff);
    assertLongEquals("Should return generated msg", msg[8] & 0xff, extraMessage[2] & 0xff);
    assertLongEquals("Should return generated msg", msg[12] & 0xff, extraMessage[6] & 0xff);
